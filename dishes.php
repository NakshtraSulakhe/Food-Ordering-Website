...
<head>
    ...
    <link rel="icon" href="#">
    <title>Dishes || Online Food Ordering System - MANTRA</title>
                ...
                <div class="modal-body cart-addon">
                    <div class="food-item white">
                        <div class="row">
                            ...
                            <div class="col-xs-6 col-sm-2 col-lg-2 text-xs-center"> <span class="price pull-left"> RS.60</span></div>
                    ...
                    <div class="food-item">
                        <div class="row">
                            ...
                            <div class="col-xs-6 col-sm-2 col-lg-2 text-xs-center"> <span class="price pull-left">RS.80</span></div>
                            <div class="col-xs-6 col-sm-4 col-lg-4">
                                <div class="row no-gutter">
                                    <div class="col-xs-7">
